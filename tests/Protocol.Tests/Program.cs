...
internal static class Program
{
    private static int Main()
    {
        var tests = new Action[] { BoundedWorkQueueTests.OverflowPreservesOrderAndCapacity,
            ...
            ShopPaymentPreviewTests.QuoteIsPresentationOnly,
            ShopPaymentPreviewTests.ChangedBasketAndUnloadRejectLateQuote,
            ShopPaymentPreviewTests.FailedOrMalformedQuoteNeverShowsFunds,
            ShopPaymentPreviewTests.PlayersDoNotSharePaymentPreview,
